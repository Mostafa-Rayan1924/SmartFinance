...
import {
  loginSchema,
  signUpSchema,
} from "@/components/validations/loginSchema";
    ...
    onSubmit: async (values) => {
      ...
      try {
        let res = await axios.post(
          "https://smart-finance-five.vercel.app/finance/api/auth/login",
          params
        );
      ...
      <div className="lg:grid pt-[120px] lg:min-h-screen lg:grid-cols-12">
        ...
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <AlertRegister
              title={"Logging in allows you to create only 3 sheets."}
            />
          </div>
        </main>
      </div>
